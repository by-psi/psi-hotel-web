object F_lancamentos: TF_lancamentos
  Left = 0
  Top = 0
  Width = 495
  Height = 627
  ...
  LayoutMgr = template_lancamentos
  HandleTabs = False
  LeftToRight = True
  ...
  object ed_conta: TIWComboBox
    ...
    Font.Size = 10
    Font.Style = []
    OnAsyncEnter = ed_contaAsyncEnter
    TabOrder = 12
    ItemIndex = -1
    FriendlyName = 'ed_conta'
    NoSelectionText = '-- No Selection --'
  end
  object RadioButton_D: TIWRadioButton
    Left = 16
    Top = 193
    Width = 60
    Height = 21
    ...
    Group = 'no group'
    Value = 'D'
    FriendlyName = 'RadioButton_D'
    SubmitOnAsyncEvent = True
  end
  object RadioButton_C: TIWRadioButton
    Left = 82
    Top = 193
    Width = 70
    Height = 21
  ...
  object Label_3: TIWLabel
    ...
    Font.Style = []
    HasTabOrder = False
    FriendlyName = 'Label_3'
    Caption = 'Label_3'
  end
  object template_lancamentos: TIWTemplateProcessorHTML
    TagType = ttIntraWeb
    OnUnknownTag = template_lancamentosUnknownTag
    RenderStyles = False
    Left = 56
    Top = 240
  end
  object frx_financeiro: TfrxReport
    Version = '6.9'
    ...
    ReportOptions.LastChange = 44201.748142407410000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'procedure Header1OnBeforePrint(Sender: TfrxComponent);'
      'begin'
      '  Memo17.Text := report.Variables['#39'dt_inicial'#39'];'
      '  Memo19.Text := report.Variables['#39'dt_final'#39'];  '
      'end;'
      ''
      'begin'
      '  Memo14.Text := report.Variables['#39'valor_total'#39'];'
      '  Memo15.Text := report.Variables['#39'dc'#39'];'
      'end.')
    Left = 56
    Top = 296
    Datasets = <
    ...
    object Page1: TfrxReportPage
      ...
      object Header1: TfrxHeader
        ...
        object Picture2: TfrxPictureView
          ...
          Picture.Data = {
            ...
            
            6082}
          HightQuality = False
          Transparent = False
      ...
      object MasterData1: TfrxMasterData
        ...
        DataSetName = 'frx_dbdataset'
        RowCount = 0
        object frx_dbdatasetDATA: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 11.338590000000000000
          Width = 79.370130000000000000
        ...
        object frx_dbdatasetCONTA: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 98.267780000000000000
          Width = 177.637910000000000000
        ...
        object frx_dbdatasetHISTORICO: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 283.464750000000000000
          Width = 272.126160000000000000
        ...
        object frx_dbdatasetTIPO: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
  ...
  object frx_dbdataset: TfrxDBDataset
    ...
    DataSet = F_session.T_lancamentos
    BCDToCurrency = False
    Left = 56
    Top = 352
  end
