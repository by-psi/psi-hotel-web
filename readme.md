...
## Histórico<br>
Projeto original desenvolvido por Ezequias Martins desde 1999, inicialmente escrito e compilado no Borland Delphi 5 usando componentes VCL nativos (Visual Component Library) para aplicações Desktop e dentro conceito de Programação Orientada a Objetos (POO), tendo sua sua base de dados toda em Paradox. O projeto foi sendo atualizado e remodelado ao longo dos anos. Com  o surgimento da versão Borland Delphi 7 em 2002, o projeto foi todo reestruturado e otimizado, sempre buscando a simplificação de código e processos, tendo também a sua base de dados migranda finalmente para o MySQL desde então. A partir de 2018, com o surgimento do RAD Studio 10 da Embarcadero, foi novamente restruturado na versão 10.3.3 Community Edition e agora está sendo remodelado para o formato Web c/ uso de componentes Intraweb + templates em HTML5/CSS, utilizando o framework Bootstrap e Javascript.
